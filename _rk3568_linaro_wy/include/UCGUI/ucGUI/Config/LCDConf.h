...
#define LCD_XSIZE      (1920)//(1920)   /* X-resolution of LCD, Logical coor. */
#define LCD_YSIZE      (1080)//(1080)   /* Y-resolution of LCD, Logical coor. */
...
#define LCD_INIT_CONTROLLER()  //LCD_InitHard();
...
//#endif  
//
////#define LCD_INIT_CONTROLLER()       /*按照例程  此部分删除*/                                                             \
